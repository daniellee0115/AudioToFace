"""
FaceFormers implemented with wav2vec augmentation.

NOTE: For the 'dropout' model, we specify our TransformerDecoderLayer as commented out in line 100.
"""
...
class Faceformer(nn.Module):
    def __init__(self, args):
        ...
        # FOR DROPOUT MODEL:
        # decoder_layer = nn.TransformerDecoderLayer(d_model=args.feature_dim, nhead=4, dim_feedforward=2*args.feature_dim, batch_first=True, dropout=0.5)
